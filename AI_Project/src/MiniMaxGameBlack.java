	...
	public static void main(String[] args) {
		...
		try {
			...
			while(s.hasNextLine()){
				...
				char[] c = mgb.swapWB(b);
				char[] a=mgb.MaxMin(c, depth);
				char[] d = mgb.swapWB(a);
				System.out.println(""+mgb.positions_evaluated);
				System.out.println(""+mgb.minimax_estimate);
				out.println("Board Position : "+new String(d));
				out.println("Positions evaluated by static estimation : "+mgb.positions_evaluated);
				out.println("MiniMax estimate : " +mgb.minimax_estimate);
